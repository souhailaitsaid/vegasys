...
@Component({
  selector: 'unites-compteurs',
  templateUrl: './unites-compteurs.component.html',
  styleUrls: ['./unites-compteurs.component.scss']
})
export class UnitesCompteursComponent implements OnInit {
  ...
  constructor(
    ...
    private service: UniteCompteurService) { }
  ...
  onDeleteConfirm(event): void {  
    if (event.data) {
      this.showLargeModal(event.data.uniteCompteurId,event)   
    }
  }
