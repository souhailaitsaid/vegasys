...
import { ModeGestionService } from '../../../@core/data/mode-gestion.service';

@Component({
  selector: 'mode-gestions',
  templateUrl: './mode-gestions.component.html',
  styleUrls: ['./mode-gestions.component.scss']
})
export class ModeGestionsComponent implements OnInit {
  ...
  constructor(
    ...
    private service: ModeGestionService) { }
  ...
  onDeleteConfirm(event): void {  
    if (event.data) {
      this.showLargeModal(event.data.modeGestionId,event)   
    }
  }
